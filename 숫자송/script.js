...
/* ============================================================
   ...
   ============================================================ */
function groupDance() {
  if (state.groupDancePlaying) return;
  ...
  nums.forEach((num, i) => {
    ...
    const delay = (i % 5) * 90 + Math.random() * 60;
    setTimeout(() => {
...
function goHome() {
  ...
  playground.classList.remove("is-active");
  playground.setAttribute("aria-hidden", "true");
  controls.classList.remove("is-active");
  controls.setAttribute("aria-hidden", "true");
  heartEgg.classList.remove("is-active");
  heartEgg.setAttribute("aria-hidden", "true");
  carrotEgg.classList.remove("is-active");
  carrotEgg.setAttribute("aria-hidden", "true");
  closeSecret();
}
